...
// #defines for all registers for the port module. This #define selects the
// IO port to use for LED output in this demo application.
...
int main( void )
{
   ...
   LEDPORT.OUTTGL = 0xff; // Toggle all pins, ones become zeros and vice versa.
   LEDPORT.OUTTGL = 0xAA; // Toggle all pins, ones become zeros and vice versa.
   LEDPORT.OUTTGL = 0xAA; // Toggle all pins, ones become zeros and vice versa.
   LEDPORT.OUTTGL = 0xAA; // Toggle all pins, ones become zeros and vice versa.
   LEDPORT.OUTTGL = 0xAA; // Toggle all pins, ones become zeros and vice versa.
